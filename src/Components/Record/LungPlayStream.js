...
export default function RecorderPlay(){
  ...
  <div className='row-span-6 my-2 mx-2'>
                <div className='cols-span-3 rounded-xl 	border-2 border-slate-900 bg-gradient-to-r from-stone-50 to-stone-50 text-center'>
                    ...
                    <div className='text-left my-2 '>
                    <p className='text-left mx-5 '>Pulse Rate (BPM)  <span className='font-extrabold text-slate-900'> 98</span> </p> 
                    <p className='text-left mx-5 '>SP02(%)  <span className='font-extrabold text-slate-900'>99</span> </p> 
                    <p className='text-left mx-5 '>Temperature (°C)  <span className='font-extrabold text-slate-900'>36.5</span> </p> 
  ...
  <button  onClick={goToLung} className='w-30 bg-red-500 drop-shadow-md  font-extrabold text-slate-100 text-4xl text-center my-3 mr-5  border-2 rounded-lg border-black-500/100 text-blue-600/100'>
        PCG
  </button>
  <div class="col-span-2 pl-10 ml-20 mt-10 h-28 ">
  <img src="http://image.free.in.th/v/2013/iu/220805012759.png" className='rounded-lg'	/>
  </div>
  <div class="col-span-2 pl-10 ml-20 mt-5 h-28 ">
  <img src="http://image.free.in.th/v/2013/if/220805110607.png" className=''	/>
  </div>
  <div class="col-span-4 mx-5 ">
  {/* http://picture.in.th/id/a624f8d1b2b9a1ed4a55ec324fdbf58b */}
   <div className='bg-gradient-to-r from-slate-200 to-slate-200 ml-11  pl-3  mr-20  '>
  <Line height="120px" options={options} data={data} /> 
   ...
   <div className='bg-gradient-to-r from-slate-200 to-slate-200  pl-3  ml-11 mr-20'>
   <Line height="120px" options={options} data={data3} />   
   </div>
   <div className="mx-3">
   <img src="http://image.free.in.th/v/2013/iw/220804061911.png"	 width={820} />
   </div>
  </div>
  <div className='mb'>
                <AudioPlayer
